...
test_endpoint "GET" "/api/wallet/health" "Wallet health"
echo ""

echo "7. Wallet Diagnostics"
echo "---------------------"
test_endpoint "GET" "/api/diagnostics/wallet-status" "Wallet status diagnostics"
test_endpoint "GET" "/api/diagnostics/transfers" "Transfer diagnostics"
test_endpoint "GET" "/api/diagnostics/email-status" "Email service status"
echo ""
