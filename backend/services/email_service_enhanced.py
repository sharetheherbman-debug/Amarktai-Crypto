        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
                ...
                <p style="color: #7f8c8d; font-size: 14px; margin-top: 30px; border-top: 1px solid #ddd; padding-top: 15px;">
                    ...
                    <strong>Amarktai Network Security Team (part of Amarktai Network)</strong>
                </p>
            </div>
        </body>
        </html>
    ...
    def daily_report(
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="max-width: 800px; margin: 0 auto; padding: 20px;">
                ...
                <p style="color: #7f8c8d; font-size: 14px; margin-top: 30px; border-top: 1px solid #ddd; padding-top: 15px;">
                    This is an automated report from your Amarktai Network trading system (part of Amarktai Network).<br>
    ...
    def critical_alert(
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 2px solid {color}; border-radius: 5px;">
                ...
                <p style="color: #7f8c8d; font-size: 14px; margin-top: 30px; border-top: 1px solid #ddd; padding-top: 15px;">
                    This is an automated alert from your Amarktai Network system (part of Amarktai Network).<br>
