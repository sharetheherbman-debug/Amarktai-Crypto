...
Handles all 9 providers: openai, fetchai, luno, binance, kucoin, bybit, kraken, bitget, gate
"""
...
async def save_key(
    ...
    try:
        ...
        VALID_PROVIDERS = ['luno', 'binance', 'kucoin', 'bybit', 'kraken', 'bitget', 'gate', 'openai', 'fetchai']
