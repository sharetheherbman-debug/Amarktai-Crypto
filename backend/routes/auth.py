...
async def get_current_user_profile(user_id: str = Depends(get_current_user)):
    ...
    try:
        ...
        system_mode = trading_mode
        automation_mode = "autopilot" if autopilot else "manual"
        sanitized_user["trading_mode"] = trading_mode
        sanitized_user["system_mode"] = system_mode
        sanitized_user["automation_mode"] = automation_mode
