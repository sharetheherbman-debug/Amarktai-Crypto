...
# NOTE: GET /api/diagnostics/go-live is implemented in routes/diagnostics.py (go_live_readiness).
# It was previously duplicated here in server.py (diagnostics_go_live), causing a startup crash.
# The canonical version in routes/diagnostics.py is mounted via the routers_to_mount list below.
