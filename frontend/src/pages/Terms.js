...
export default function Terms() {
  return (
    <PublicPageLayout
      title="Terms of Use"
      subtitle="Please review the terms for personal use of Amarktai Crypto."
    >
      <p style={{ margin: 0, color: 'var(--muted)', lineHeight: 1.6 }}>
        Amarktai Crypto is provided for personal, educational, and research purposes. You are responsible for
